...
def conv_img():
    ...
    parser.add_argument(
        "-l", "--limit", type=int, help="number of images after which script breaks off, defaults to -1 (no limit)", default=-1
    )

    parser.add_argument(
        "-m", "--max_size", type=int, help="max size of pixel, defaults to 6000 pixel for the longest size", default=6000
    )
